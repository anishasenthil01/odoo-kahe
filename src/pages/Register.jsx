  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden bg-slate-900">
      ...
      <div className="hidden lg:flex lg:w-3/5 items-center justify-center relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1501785888041-af3ef285b470?q=80&w=2070')] bg-cover bg-center group-hover:scale-110 transition-transform duration-[10s]"></div>
        ...
        <div className="relative z-10 text-white p-20 max-w-2xl animate-in fade-in slide-in-from-left duration-1000">
          ...
          <h2 className="text-5xl font-black mb-8 leading-tight tracking-tight">Begin Your <br/><span className="text-teal-400">Grand Adventure.</span></h2>
          <p className="text-slate-300 text-xl font-medium leading-relaxed max-w-lg">
            Create your account in seconds and unlock a world of seamless travel planning, budgeting, and sharing.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-2/5 flex items-center justify-center p-8 lg:p-16 relative z-10">
        <div className="w-full max-w-md glass-card p-12 border-white/10 bg-white/5 backdrop-blur-3xl shadow-2xl">
          <div className="mb-12 text-center">
            ...
            <p className="text-slate-400 font-bold uppercase text-[10px] tracking-[0.2em]">Join the global community</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-teal-500 hover:bg-teal-400 text-white font-black py-5 rounded-2xl transition-all duration-300 shadow-2xl shadow-teal-500/20 active:scale-[0.98] mt-6 flex items-center justify-center gap-3"
            >
              {loading ? (
          ...
          <p className="mt-12 text-center text-sm text-slate-500 font-bold">
            Already exploring?{' '}
            <Link to="/login" className="text-teal-400 hover:text-teal-300 transition-colors font-black">
              Sign in here
            </Link>
          </p>
        </div>
